...
class MO6_Visit_record(models.Model):
    ...
    def __str__(self):
        ...
        if self.MO3_DspotNumber:
            spot_name = self.MO3_DspotNumber.MO2_storeNumber.MO2_storeName
        else:
            spot_name = self.MO4_OspotNumber.MO4_OspotName
        return f'{date}-{spot_name}'
