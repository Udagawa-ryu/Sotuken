...
class MO4_Original_spot(models.Model):
  ...
  MO4_OspotLat = models.FloatField(verbose_name="オリジナルスポットY座標",blank=True,null=True)
  MO4_OspotLng = models.FloatField(verbose_name="オリジナルスポットY座標",blank=True,null=True)
