...
def member_file_path(instance, filename):
    return f'store_images/{instance.MO2_storeNumber}-{instance.MO2_storeName}/{filename}'
class MO2_store(models.Model):
    ...
    MO2_images1 = models.ImageField(verbose_name="店舗画像1",upload_to=member_file_path,null=True,blank=True)
    MO2_images2 = models.ImageField(verbose_name="店舗画像2",upload_to=member_file_path,null=True,blank=True)
    MO2_images3 = models.ImageField(verbose_name="店舗画像3",upload_to=member_file_path,null=True,blank=True)
