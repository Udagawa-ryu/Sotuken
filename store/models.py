...
class MO2_store(models.Model):
    ...
    url = "store"+str(MO2_storeName)+"/"
    MO2_images1 = models.ImageField(verbose_name="店舗画像1",upload_to=url,null=True,blank=True)
    MO2_images2 = models.ImageField(verbose_name="店舗画像2",upload_to=url,null=True,blank=True)
    MO2_images3 = models.ImageField(verbose_name="店舗画像3",upload_to=url,null=True,blank=True)
